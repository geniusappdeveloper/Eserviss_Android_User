...
public class Scaler {
	...
	/*public static  double[] getScalingFactor(android.app.Activity context)
	{
		dm = new DisplayMetrics();
		...
		array[0]=scalingFactor_Width/(dm.xdpi / DisplayMetrics.DENSITY_DEFAULT);
		array[1]=scalingFactor_Height/(dm.ydpi / DisplayMetrics.DENSITY_DEFAULT);
		return array;
	}*/
	...
	public static  double[] getScalingFactorwithDpConvesion(android.app.Activity context)
	{
		dm = new DisplayMetrics();
    	WindowManager windowManager = (WindowManager) context
                   .getSystemService(Context.WINDOW_SERVICE);
